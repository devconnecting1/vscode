...
// Stubs for deleted service interfaces
export const IClaudeAgentSdkService = Symbol('IClaudeAgentSdkService');
export interface IClaudeAgentSdkService { readonly _serviceBrand: undefined }
class ClaudeAgentSdkService implements IClaudeAgentSdkService { declare readonly _serviceBrand: undefined; }

export const IClaudeProxyService = Symbol('IClaudeProxyService');
export interface IClaudeProxyService { readonly _serviceBrand: undefined }
class ClaudeProxyService implements IClaudeProxyService { declare readonly _serviceBrand: undefined; }

export const ICodexProxyService = Symbol('ICodexProxyService');
export interface ICodexProxyService { readonly _serviceBrand: undefined }
class CodexProxyService implements ICodexProxyService { declare readonly _serviceBrand: undefined; }

export const IByokLmProxyService = Symbol('IByokLmProxyService');
export interface IByokLmProxyService { readonly _serviceBrand: undefined }
class ByokLmProxyService implements IByokLmProxyService { declare readonly _serviceBrand: undefined; }
class NullByokLmProxyService implements IByokLmProxyService { declare readonly _serviceBrand: undefined; }
