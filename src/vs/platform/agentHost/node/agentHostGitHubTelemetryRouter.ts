...
// Inline stub for deleted @github/copilot-sdk
export interface GitHubTelemetryNotification {
	readonly event: { readonly kind: string; readonly properties?: Record<string, unknown>; readonly metrics?: Record<string, unknown> };
